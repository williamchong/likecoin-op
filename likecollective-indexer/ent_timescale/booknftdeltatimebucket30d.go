...
// BookNFTDeltaTimeBucket30d is the model entity for the BookNFTDeltaTimeBucket30d schema.
...
func (*BookNFTDeltaTimeBucket30d) scanValues(columns []string) ([]any, error) {
	values := make([]any, len(columns))
	for i := range columns {
		switch columns[i] {
		case booknftdeltatimebucket30d.FieldNumberOfStakers:
			values[i] = new(sql.NullInt64)
		case booknftdeltatimebucket30d.FieldID, booknftdeltatimebucket30d.FieldEvmAddress:
			values[i] = new(sql.NullString)
		case booknftdeltatimebucket30d.FieldBucket, booknftdeltatimebucket30d.FieldLastStakedAt:
			values[i] = new(sql.NullTime)
		case booknftdeltatimebucket30d.FieldStakedAmount:
			values[i] = booknftdeltatimebucket30d.ValueScanner.StakedAmount.ScanValue()
		default:
...
// to the BookNFTDeltaTimeBucket30d fields.
func (_m *BookNFTDeltaTimeBucket30d) assignValues(columns []string, values []any) error {
	if m, n := len(values), len(columns); m < n {
		return fmt.Errorf("mismatch number of scan values: %d != %d", m, n)
	}
	for i := range columns {
		switch columns[i] {
		case booknftdeltatimebucket30d.FieldID:
		...
		case booknftdeltatimebucket30d.FieldStakedAmount:
			if value, err := booknftdeltatimebucket30d.ValueScanner.StakedAmount.FromValue(values[i]); err != nil {
				return err
			} else {
...
// Value returns the ent.Value that was dynamically selected and assigned to the BookNFTDeltaTimeBucket30d.
// This includes values selected through modifiers, order, etc.
func (_m *BookNFTDeltaTimeBucket30d) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// Update returns a builder for updating this BookNFTDeltaTimeBucket30d.
// Note that you need to call BookNFTDeltaTimeBucket30d.Unwrap() before calling this method if this BookNFTDeltaTimeBucket30d
// was returned from a transaction, and the transaction was committed or rolled back.
func (_m *BookNFTDeltaTimeBucket30d) Update() *BookNFTDeltaTimeBucket30dUpdateOne {
	return NewBookNFTDeltaTimeBucket30dClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the BookNFTDeltaTimeBucket30d entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *BookNFTDeltaTimeBucket30d) Unwrap() *BookNFTDeltaTimeBucket30d {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("ent_timescale: BookNFTDeltaTimeBucket30d is not a transactional entity")
	}
...
func (_m *BookNFTDeltaTimeBucket30d) String() string {
	var builder strings.Builder
	builder.WriteString("BookNFTDeltaTimeBucket30d(")
...
// BookNFTDeltaTimeBucket30ds is a parsable slice of BookNFTDeltaTimeBucket30d.
type BookNFTDeltaTimeBucket30ds []*BookNFTDeltaTimeBucket30d
