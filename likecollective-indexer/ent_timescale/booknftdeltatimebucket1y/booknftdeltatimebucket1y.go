...
const (
	// Label holds the string label denoting the booknftdeltatimebucket1y type in the database.
	Label = "book_nft_delta_time_bucket1y"
	...
	// Table holds the table name of the booknftdeltatimebucket1y in the database.
	Table = "book_nft_delta_time_bucket_1y"
)

// Columns holds all SQL columns for booknftdeltatimebucket1y fields.
var Columns = []string{
	FieldID,
	FieldEvmAddress,
	FieldBucket,
...
var (
	...
	// ValueScanner of all BookNFTDeltaTimeBucket1y fields.
	ValueScanner struct {
		StakedAmount field.TypeValueScanner[typeutil.Uint256]
	}
)

// OrderOption defines the ordering options for the BookNFTDeltaTimeBucket1y queries.
