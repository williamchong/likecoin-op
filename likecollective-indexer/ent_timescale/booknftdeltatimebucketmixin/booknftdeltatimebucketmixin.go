...
const (
	// Label holds the string label denoting the booknftdeltatimebucketmixin type in the database.
	Label = "book_nft_delta_time_bucket_mixin"
	...
	// Table holds the table name of the booknftdeltatimebucketmixin in the database.
	Table = "book_nft_delta_time_bucket_mixins"
)

// Columns holds all SQL columns for booknftdeltatimebucketmixin fields.
var Columns = []string{
	FieldID,
	FieldEvmAddress,
	FieldBucket,
...
var (
	...
	// ValueScanner of all BookNFTDeltaTimeBucketMixin fields.
	ValueScanner struct {
		StakedAmount field.TypeValueScanner[typeutil.Uint256]
	}
)

// OrderOption defines the ordering options for the BookNFTDeltaTimeBucketMixin queries.
