...
const (
	// Label holds the string label denoting the booknftdeltatimebucket7d type in the database.
	Label = "book_nft_delta_time_bucket7d"
	...
	// Table holds the table name of the booknftdeltatimebucket7d in the database.
	Table = "book_nft_delta_time_bucket_7d"
)

// Columns holds all SQL columns for booknftdeltatimebucket7d fields.
var Columns = []string{
	FieldID,
	FieldEvmAddress,
	FieldBucket,
...
var (
	...
	// ValueScanner of all BookNFTDeltaTimeBucket7d fields.
	ValueScanner struct {
		StakedAmount field.TypeValueScanner[typeutil.Uint256]
	}
)

// OrderOption defines the ordering options for the BookNFTDeltaTimeBucket7d queries.
