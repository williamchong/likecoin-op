...
// BookNFTDeltaTimeBucketMixin is the model entity for the BookNFTDeltaTimeBucketMixin schema.
...
func (*BookNFTDeltaTimeBucketMixin) scanValues(columns []string) ([]any, error) {
	values := make([]any, len(columns))
	for i := range columns {
		switch columns[i] {
		case booknftdeltatimebucketmixin.FieldNumberOfStakers:
			values[i] = new(sql.NullInt64)
		case booknftdeltatimebucketmixin.FieldID, booknftdeltatimebucketmixin.FieldEvmAddress:
			values[i] = new(sql.NullString)
		case booknftdeltatimebucketmixin.FieldBucket, booknftdeltatimebucketmixin.FieldLastStakedAt:
			values[i] = new(sql.NullTime)
		case booknftdeltatimebucketmixin.FieldStakedAmount:
			values[i] = booknftdeltatimebucketmixin.ValueScanner.StakedAmount.ScanValue()
		default:
...
// to the BookNFTDeltaTimeBucketMixin fields.
func (_m *BookNFTDeltaTimeBucketMixin) assignValues(columns []string, values []any) error {
	if m, n := len(values), len(columns); m < n {
		return fmt.Errorf("mismatch number of scan values: %d != %d", m, n)
	}
	for i := range columns {
		switch columns[i] {
		case booknftdeltatimebucketmixin.FieldID:
		...
		case booknftdeltatimebucketmixin.FieldStakedAmount:
			if value, err := booknftdeltatimebucketmixin.ValueScanner.StakedAmount.FromValue(values[i]); err != nil {
				return err
			} else {
...
// Value returns the ent.Value that was dynamically selected and assigned to the BookNFTDeltaTimeBucketMixin.
// This includes values selected through modifiers, order, etc.
func (_m *BookNFTDeltaTimeBucketMixin) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// Update returns a builder for updating this BookNFTDeltaTimeBucketMixin.
// Note that you need to call BookNFTDeltaTimeBucketMixin.Unwrap() before calling this method if this BookNFTDeltaTimeBucketMixin
// was returned from a transaction, and the transaction was committed or rolled back.
func (_m *BookNFTDeltaTimeBucketMixin) Update() *BookNFTDeltaTimeBucketMixinUpdateOne {
	return NewBookNFTDeltaTimeBucketMixinClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the BookNFTDeltaTimeBucketMixin entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *BookNFTDeltaTimeBucketMixin) Unwrap() *BookNFTDeltaTimeBucketMixin {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("ent_timescale: BookNFTDeltaTimeBucketMixin is not a transactional entity")
	}
...
func (_m *BookNFTDeltaTimeBucketMixin) String() string {
	var builder strings.Builder
	builder.WriteString("BookNFTDeltaTimeBucketMixin(")
...
// BookNFTDeltaTimeBucketMixins is a parsable slice of BookNFTDeltaTimeBucketMixin.
type BookNFTDeltaTimeBucketMixins []*BookNFTDeltaTimeBucketMixin
