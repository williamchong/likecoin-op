...
func (s AccountBookNFTsRequestSortOrder) Validate() error {
	switch s {
	case "asc":
		return nil
	case "desc":
...
func (s *AccountEvmAddressBookNftsGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s BookNFTsRequestSortOrderTimeFrame) Validate() error {
	switch s {
	case "7d":
		return nil
	case "30d":
...
func (s BookNFTsRequestTimeFrameSortBy) Validate() error {
	switch s {
	case "staked_amount":
		return nil
	case "last_staked_at":
...
func (s BookNFTsRequestTimeFrameSortOrder) Validate() error {
	switch s {
	case "asc":
		return nil
	case "desc":
