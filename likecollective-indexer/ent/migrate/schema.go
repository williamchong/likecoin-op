...
var (
	...
	StakingEventsColumns = []*schema.Column{
		...
		{Name: "block_number", Type: field.TypeUint64, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "log_index", Type: field.TypeUint},
		{Name: "event_type", Type: field.TypeEnum, Enums: []string{"staked", "unstaked", "reward_claimed", "reward_deposited", "reward_deposit_distributed", "all_rewards_claimed", "stake_position_transferred", "stake_position_received"}, Default: "staked"},
