...
const (
	...
	TypeStakingStateHead = "StakingStateHead"
)
...
// StakingStateHeadMutation represents an operation that mutates the StakingStateHead nodes in the graph.
type StakingStateHeadMutation struct {
	config
	op              Op
	typ             string
	id              *int
	...
	oldValue        func(context.Context) (*StakingStateHead, error)
	predicates      []predicate.StakingStateHead
}

var _ ent.Mutation = (*StakingStateHeadMutation)(nil)

// stakingstateheadOption allows management of the mutation configuration using functional options.
type stakingstateheadOption func(*StakingStateHeadMutation)

// newStakingStateHeadMutation creates new mutation for the StakingStateHead entity.
func newStakingStateHeadMutation(c config, op Op, opts ...stakingstateheadOption) *StakingStateHeadMutation {
	m := &StakingStateHeadMutation{
		config:        c,
		op:            op,
		typ:           TypeStakingStateHead,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withStakingStateHeadID sets the ID field of the mutation.
func withStakingStateHeadID(id int) stakingstateheadOption {
	return func(m *StakingStateHeadMutation) {
		var (
			err   error
			once  sync.Once
			value *StakingStateHead
		)
		m.oldValue = func(ctx context.Context) (*StakingStateHead, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().StakingStateHead.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withStakingStateHead sets the old StakingStateHead of the mutation.
func withStakingStateHead(node *StakingStateHead) stakingstateheadOption {
	return func(m *StakingStateHeadMutation) {
		m.oldValue = func(context.Context) (*StakingStateHead, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m StakingStateHeadMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m StakingStateHeadMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *StakingStateHeadMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *StakingStateHeadMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().StakingStateHead.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetBlockNumber sets the "block_number" field.
func (m *StakingStateHeadMutation) SetBlockNumber(t typeutil.Uint64) {
	m.block_number = &t
	m.addblock_number = nil
}

// BlockNumber returns the value of the "block_number" field in the mutation.
func (m *StakingStateHeadMutation) BlockNumber() (r typeutil.Uint64, exists bool) {
	v := m.block_number
	if v == nil {
		return
	}
...
// OldBlockNumber returns the old "block_number" field's value of the StakingStateHead entity.
// If the StakingStateHead object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StakingStateHeadMutation) OldBlockNumber(ctx context.Context) (v typeutil.Uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBlockNumber is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddBlockNumber adds t to the "block_number" field.
func (m *StakingStateHeadMutation) AddBlockNumber(t typeutil.Uint64) {
	if m.addblock_number != nil {
		*m.addblock_number += t
	} else {
		m.addblock_number = &t
...
// AddedBlockNumber returns the value that was added to the "block_number" field in this mutation.
func (m *StakingStateHeadMutation) AddedBlockNumber() (r typeutil.Uint64, exists bool) {
	v := m.addblock_number
	if v == nil {
		return
	}
...
// ResetBlockNumber resets all changes to the "block_number" field.
func (m *StakingStateHeadMutation) ResetBlockNumber() {
	m.block_number = nil
	m.addblock_number = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *StakingStateHeadMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *StakingStateHeadMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the StakingStateHead entity.
// If the StakingStateHead object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StakingStateHeadMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *StakingStateHeadMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the StakingStateHeadMutation builder.
func (m *StakingStateHeadMutation) Where(ps ...predicate.StakingStateHead) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the StakingStateHeadMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *StakingStateHeadMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.StakingStateHead, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *StakingStateHeadMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *StakingStateHeadMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (StakingStateHead).
func (m *StakingStateHeadMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *StakingStateHeadMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.block_number != nil {
		fields = append(fields, stakingstatehead.FieldBlockNumber)
	}
	if m.updated_at != nil {
		fields = append(fields, stakingstatehead.FieldUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *StakingStateHeadMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *StakingStateHeadMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case stakingstatehead.FieldBlockNumber:
		return m.OldBlockNumber(ctx)
	case stakingstatehead.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown StakingStateHead field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *StakingStateHeadMutation) SetField(name string, value ent.Value) error {
	switch name {
	case stakingstatehead.FieldBlockNumber:
		v, ok := value.(typeutil.Uint64)
		if !ok {
	...
	return fmt.Errorf("unknown StakingStateHead field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *StakingStateHeadMutation) AddedFields() []string {
	var fields []string
	if m.addblock_number != nil {
		fields = append(fields, stakingstatehead.FieldBlockNumber)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *StakingStateHeadMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case stakingstatehead.FieldBlockNumber:
		return m.AddedBlockNumber()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *StakingStateHeadMutation) AddField(name string, value ent.Value) error {
	switch name {
	case stakingstatehead.FieldBlockNumber:
		v, ok := value.(typeutil.Uint64)
		if !ok {
	...
	return fmt.Errorf("unknown StakingStateHead numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *StakingStateHeadMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *StakingStateHeadMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *StakingStateHeadMutation) ClearField(name string) error {
	return fmt.Errorf("unknown StakingStateHead nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *StakingStateHeadMutation) ResetField(name string) error {
	switch name {
	case stakingstatehead.FieldBlockNumber:
		m.ResetBlockNumber()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *StakingStateHeadMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *StakingStateHeadMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *StakingStateHeadMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *StakingStateHeadMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *StakingStateHeadMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *StakingStateHeadMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *StakingStateHeadMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown StakingStateHead unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *StakingStateHeadMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown StakingStateHead edge %s", name)
}
