...
type loadStakePositionReceivedStateFactory struct {
...
func MakeLoadStakePositionReceivedStateFactory(stakingEvent *ent.StakingEvent) LoadStateFactory {
	...
	return &loadStakePositionReceivedStateFactory{
		stakingEvent,
		accountEVMAddress,
		nftClassAddress,
	}
...
func (f *loadStakePositionReceivedStateFactory) MakeLoadState() *LoadState {
	return &LoadState{
