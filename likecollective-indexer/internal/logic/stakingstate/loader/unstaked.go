...
type loadUnstakedStateFactory struct {
...
func MakeLoadUnstakedStateFactory(
	stakingEvent *ent.StakingEvent,
) LoadStateFactory {
	...
	return &loadUnstakedStateFactory{
		stakingEvent,
		accountEVMAddress,
		nftClassAddress,
	}
...
func (f *loadUnstakedStateFactory) MakeLoadState() *LoadState {
	return &LoadState{
