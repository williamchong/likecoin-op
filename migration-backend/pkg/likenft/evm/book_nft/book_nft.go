...
func (_BookNft *BookNftTransactor) Update(opts *bind.TransactOpts, classInput ClassInput) (*types.Transaction, error) {
	return _BookNft.contract.Transact(opts, "update", classInput)
}

// Update is a paid mutator transaction binding the contract method 0x765a15bb.
//
// Solidity: function update((string,string,string,(uint64)) classInput) returns()
func (_BookNft *BookNftSession) Update(classInput ClassInput) (*types.Transaction, error) {
	return _BookNft.Contract.Update(&_BookNft.TransactOpts, classInput)
}

// Update is a paid mutator transaction binding the contract method 0x765a15bb.
//
// Solidity: function update((string,string,string,(uint64)) classInput) returns()
func (_BookNft *BookNftTransactorSession) Update(classInput ClassInput) (*types.Transaction, error) {
	return _BookNft.Contract.Update(&_BookNft.TransactOpts, classInput)
}
