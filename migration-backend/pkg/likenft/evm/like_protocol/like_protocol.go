...
// GetRoyaltyReceiver is a free data retrieval call binding the contract method 0xa5bd5235.
//
// Solidity: function getRoyaltyReceiver() view returns(address)
func (_LikeProtocol *LikeProtocolCaller) GetRoyaltyReceiver(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _LikeProtocol.contract.Call(opts, &out, "getRoyaltyReceiver")
...
//
// Solidity: function getRoyaltyReceiver() view returns(address)
func (_LikeProtocol *LikeProtocolSession) GetRoyaltyReceiver() (common.Address, error) {
	return _LikeProtocol.Contract.GetRoyaltyReceiver(&_LikeProtocol.CallOpts)
}

// GetRoyaltyReceiver is a free data retrieval call binding the contract method 0xa5bd5235.
//
// Solidity: function getRoyaltyReceiver() view returns(address)
func (_LikeProtocol *LikeProtocolCallerSession) GetRoyaltyReceiver() (common.Address, error) {
	return _LikeProtocol.Contract.GetRoyaltyReceiver(&_LikeProtocol.CallOpts)
}
...
// NewBookNFTWithRoyaltyAndSalt is a paid mutator transaction binding the contract method 0xb2de5022.
//
// Solidity: function newBookNFTWithRoyaltyAndSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT, uint96 royaltyFraction) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolTransactor) NewBookNFTWithRoyaltyAndSalt(opts *bind.TransactOpts, salt [32]byte, msgNewBookNFT MsgNewBookNFT, royaltyFraction *big.Int) (*types.Transaction, error) {
	return _LikeProtocol.contract.Transact(opts, "newBookNFTWithRoyaltyAndSalt", salt, msgNewBookNFT, royaltyFraction)
}

// NewBookNFTWithRoyaltyAndSalt is a paid mutator transaction binding the contract method 0xb2de5022.
//
// Solidity: function newBookNFTWithRoyaltyAndSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT, uint96 royaltyFraction) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolSession) NewBookNFTWithRoyaltyAndSalt(salt [32]byte, msgNewBookNFT MsgNewBookNFT, royaltyFraction *big.Int) (*types.Transaction, error) {
	return _LikeProtocol.Contract.NewBookNFTWithRoyaltyAndSalt(&_LikeProtocol.TransactOpts, salt, msgNewBookNFT, royaltyFraction)
}

// NewBookNFTWithRoyaltyAndSalt is a paid mutator transaction binding the contract method 0xb2de5022.
//
// Solidity: function newBookNFTWithRoyaltyAndSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT, uint96 royaltyFraction) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolTransactorSession) NewBookNFTWithRoyaltyAndSalt(salt [32]byte, msgNewBookNFT MsgNewBookNFT, royaltyFraction *big.Int) (*types.Transaction, error) {
	return _LikeProtocol.Contract.NewBookNFTWithRoyaltyAndSalt(&_LikeProtocol.TransactOpts, salt, msgNewBookNFT, royaltyFraction)
}

// NewBookNFTWithSalt is a paid mutator transaction binding the contract method 0xb18093ea.
//
// Solidity: function newBookNFTWithSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolTransactor) NewBookNFTWithSalt(opts *bind.TransactOpts, salt [32]byte, msgNewBookNFT MsgNewBookNFT) (*types.Transaction, error) {
	return _LikeProtocol.contract.Transact(opts, "newBookNFTWithSalt", salt, msgNewBookNFT)
}

// NewBookNFTWithSalt is a paid mutator transaction binding the contract method 0xb18093ea.
//
// Solidity: function newBookNFTWithSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolSession) NewBookNFTWithSalt(salt [32]byte, msgNewBookNFT MsgNewBookNFT) (*types.Transaction, error) {
	return _LikeProtocol.Contract.NewBookNFTWithSalt(&_LikeProtocol.TransactOpts, salt, msgNewBookNFT)
}

// NewBookNFTWithSalt is a paid mutator transaction binding the contract method 0xb18093ea.
//
// Solidity: function newBookNFTWithSalt(bytes32 salt, (address,address[],address[],(string,string,string,uint64)) msgNewBookNFT) returns(address bookAddress)
func (_LikeProtocol *LikeProtocolTransactorSession) NewBookNFTWithSalt(salt [32]byte, msgNewBookNFT MsgNewBookNFT) (*types.Transaction, error) {
	return _LikeProtocol.Contract.NewBookNFTWithSalt(&_LikeProtocol.TransactOpts, salt, msgNewBookNFT)
}
...
// SetRoyaltyReceiver is a paid mutator transaction binding the contract method 0x8dc251e3.
//
// Solidity: function setRoyaltyReceiver(address royaltyReceiver) returns()
func (_LikeProtocol *LikeProtocolTransactor) SetRoyaltyReceiver(opts *bind.TransactOpts, royaltyReceiver common.Address) (*types.Transaction, error) {
	return _LikeProtocol.contract.Transact(opts, "setRoyaltyReceiver", royaltyReceiver)
}

// SetRoyaltyReceiver is a paid mutator transaction binding the contract method 0x8dc251e3.
//
// Solidity: function setRoyaltyReceiver(address royaltyReceiver) returns()
func (_LikeProtocol *LikeProtocolSession) SetRoyaltyReceiver(royaltyReceiver common.Address) (*types.Transaction, error) {
	return _LikeProtocol.Contract.SetRoyaltyReceiver(&_LikeProtocol.TransactOpts, royaltyReceiver)
}

// SetRoyaltyReceiver is a paid mutator transaction binding the contract method 0x8dc251e3.
//
// Solidity: function setRoyaltyReceiver(address royaltyReceiver) returns()
func (_LikeProtocol *LikeProtocolTransactorSession) SetRoyaltyReceiver(royaltyReceiver common.Address) (*types.Transaction, error) {
	return _LikeProtocol.Contract.SetRoyaltyReceiver(&_LikeProtocol.TransactOpts, royaltyReceiver)
}
