...
var EnqueueLikeNFTAssetMigrationCmd = &cobra.Command{
	Use:   "enqueue-likenft-asset-migration likenft-asset-migration-id",
	Short: "Enqueue LikeNFT asset migration",
	Run: func(cmd *cobra.Command, args []string) {
		...
		task, err := task.NewEnqueueLikeNFTAssetMigrationTask(id)
		if err != nil {
