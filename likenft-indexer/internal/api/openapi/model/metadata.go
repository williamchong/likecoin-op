...
func MakeOptContractLevelMetadata(e *model.ContractLevelMetadataOpenSea, additionalProps APIAdditionalProps) api.OptContractLevelMetadata {
	if e == nil {
	...
	return api.NewOptContractLevelMetadata(api.ContractLevelMetadata{
		...
		AdditionalProps: api.ContractLevelMetadataAdditional(additionalProps),
	})
}
